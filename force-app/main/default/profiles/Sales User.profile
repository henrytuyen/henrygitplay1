...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>fsAccountPriceListHandler</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>fsContactHandler</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>fsCreateOpportunityToCRM2Batch</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>fsOpportunityHandler</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>true</custom>
    <description>Use this profile for Sales User</description>
